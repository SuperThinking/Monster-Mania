...
function clearAll()
{
    ...
    if(localStorage.getItem("hScore")<score||localStorage.getItem("hScore")==null)
    {
        ...
        localStorage.setItem("hName", newHScore);
    }
    //setTimeout(function(){ alert("GAME OVER\nFinal Score : "+score+"\nPress F5 to Play Again"); }, 2000);
}

//Below was commented on 7/8/18 
//Changing Faces with Bot causes the game to glitch at high speeds, therefore only used in SinglePlayer
...
function getHighestScore()
{
    if(localStorage.getItem("hScore")!=null)
    {
        ...
        $("#highestScore").html(hScore);
        $("#highestScoreName").html(hName);
    }
}
